...
const FeaturesListicle = () => {
	...
	return (
		<section className="py-24" id="features">
            ...
            Predict race outcomes, compete with friends, and enhance your biathlon
            viewing experience. Focus on the sport you love while we handle
            the complex statistics and analysis for you.
					</div>
				</div>
			</div>

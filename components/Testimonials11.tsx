...
const list: {
  ...
  videoType?: 'video/ogg' | 'video/mp4' | 'video/webm';
	...
	{
		name: 'Yazdun',
		text: 'The prediction system is fantastic! It helps me understand the sport better and makes watching so much more engaging.',
		type: refTypes.other,
	},
	{
		name: 'Thomas Anderson',
		text: 'The prediction leagues are exactly what I didn\'t even know I needed. So addictive!',
		type: refTypes.other,
	},
	{
		username: 'zawwadx',
	...
	{
		username: 'biathlon_pro',
		name: 'Victor Abeledo',
		text: 'This platform has revolutionized how I follow biathlon. The detailed statistics and prediction tools are incredible. It\'s like having a coach\'s perspective on every race. 100% worth it 🚀🚀🚀',
		type: refTypes.other,
		link: '',
	},
];
